...
export default function CaseWizardHeader() {
    ...
    useWatch({ control, name: ['product','priority','version','Id_Origem','descricao_resumo','descricao_completa','usuario_id','project','relator_id'] as any });
    ...
    const fieldsHeader = ['product','priority','version','Id_Origem'];
